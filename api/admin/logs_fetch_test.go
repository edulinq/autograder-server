...
func TestFetchLogs(test *testing.T) {
    ...
    testCases := []struct{
        ...
        // Parse Errors.
        {model.RoleAdmin, false, "ZZZ", "", "", "", []string{"Could not parse 'level' componet of log query ('ZZZ'): 'Unknown log level 'ZZZ'.'."}, nil},
        {model.RoleAdmin, false, "", "ZZZ", "", "", []string{`Could not parse 'after' componet of log query ('ZZZ'): 'Failed to parse timestamp string 'ZZZ': 'parsing time "ZZZ" as "2006-01-02T15:04:05Z07:00": cannot parse "ZZZ" as "2006"'.'.`}, nil},
        {model.RoleAdmin, false, "", "", "!ZZZ", "", []string{"Could not parse 'assignment' componet of log query ('!ZZZ'): 'IDs must only have letters, digits, and single sequences of periods, underscores, and hyphens, found '!zzz'.'."}, nil},
        {model.RoleAdmin, false, "", "", "ZZZ", "", []string{"Unknown assignment given for 'assignment' componet of log query ('ZZZ')."}, nil},
